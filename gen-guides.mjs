...
// Wave 2+ companies come from wave2.json (generated by merge-wave2.mjs from agent research).
try { const _w2 = JSON.parse(fs.readFileSync(path.join(ROOT,'wave2.json'),'utf8')); COMPANIES.push(..._w2); } catch(e){ console.error('wave2 load skipped:', e.message); }
